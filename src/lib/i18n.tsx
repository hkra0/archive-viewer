...
const messages = {
  "zh-CN": {
    archiveData: "归档内容", profile: "个人资料", projects: "项目", memories: "记忆", tasks: "计划任务", assistants: "自定义助手", customInstructions: "自定义指令", otherData: "其他资料", archiveItemCount: "{count} 项内容", archiveItem: "内容 {count}",
    ...
    export: "导出", copyBranch: "复制当前分支", copyBranchHint: "只复制当前通过箭头选中的对话路径。", copied: "已复制", copyFailed: "复制失败", copyConversation: "复制对话", copyMemory: "复制记忆", include: "包含内容", title: "标题", roles: "角色", timestamps: "时间", models: "模型", missingPlaceholders: "缺失消息占位", continuation: "继续对话提示词", restoreDefault: "恢复默认",
